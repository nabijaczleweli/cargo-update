...
/// # let cargo_dir = ();
/// # let packages_to_update = [("racer".to_string(), None, "registry+https://github.com/rust-lang/crates.io-index".to_string()),
/// #                           ("cargo-outdated".to_string(), None, "registry+https://github.com/rust-lang/crates.io-index".to_string())];
